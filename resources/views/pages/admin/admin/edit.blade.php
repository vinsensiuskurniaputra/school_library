<x-layouts.admin.app title="Edit Librarian">
    <h1 class='font-bold text-[40px]'>Edit Librarian</h1>
    <form action="{{ route('admin.admin.update', $user) }}" class="grid" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="grid my-2">
            <label for="username" class='font-medium text-[20px]'>Username ({{$user->username }})   </label>
        ...
        <div class="grid my-2">
            ...
            <input type='text' placeholder='Address' id='address' name="address" value="{{ old('address') ?? $user->address }}"
                class='inputMain' />
            @error('address')
                <span class="text-red-500">{{ $message }}</span>
            @enderror
        ...
        <h1 class='font-bold text-[25px]'>Edit Password</h1>
        <div class="grid my-2">
        ...
        <div class="grid my-2">
            ...
            <input type='password' placeholder='Konfimasi Password' id='password_confirmation'
                name="password_confirmation" value="{{ old('password_confirmation') }}" class='inputMain' />
